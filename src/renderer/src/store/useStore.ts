...
export const useStore = create<AppState>((set) => ({
  ...
  setSelectedChannelId: (id) => set({ selectedChannelId: id, messages: [], isArchiveView: false }),
  ...
  reset: () => set({ token: null, channels: [], selectedChannelId: null, messages: [], error: null, isArchiveView: false })
}))
